...
const Button = ({
  ...
  return (
    <Link href={href}>
      <a
        className={`${bgClass} ${bgHoverClass} ${noPaddingClass} ${fontClass} ${roundedOnlyBigScreenClass} flex items-center text-white ${additionalClassNames}`}
      ...
      >
        ...
        {buttonHovered ? (
          <svg
            ...
            className="w-3 h-3 md:w-2 md:h-2  fill-current md:mt-0.5"
            x="0"
            y="0"
          ...
          <svg
            ...
            x="0"
            y="0"
            className="w-2.5 h-2.5 md:w-2 md:h-2  fill-current md:mt-0.5"
